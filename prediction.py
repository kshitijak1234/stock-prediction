...
def main():
    ...
    recommendation = generate_recommendations(predicted_price, current_price)
    ...
    # Displaying recommendations in percentage using horizontal bar graph
    st.write("Recommendations Percentage:")
    st.bar_chart(recommendations_df.T)
